						...
						<div class="table-responsive">
                            <table class="table table-striped custom-table">
                                ...
                                <tbody>
                                    ...
                                    $hosp=$row_data['hospital_id'];

                                     $query=mysqli_query($conn,"SELECT * FROM `blood_donation_tb` JOIN registration_tb ON blood_donation_tb.reg_id=registration_tb.reg_id  ");
                                     $count=0;
