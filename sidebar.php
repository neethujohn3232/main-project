                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                       ...
                       <!--  <li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fa fa-hospital-o"></i> <span> Manage Hospital </span> <span class="menu-arrow"></span></a>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                       ...
                       <!--  <li>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fa fa-hospital-o"></i> <span> Manage Department</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
